...
this project currently misses the EKS and ingress-controller as it is created for showcasing the skills of devops engineer , with minor changes the project will be all set for the production !
...
```bash
docker run -p 8000:8000 <your-docker-username>/go-web-app
```
